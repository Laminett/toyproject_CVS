...
public class SystemApiController {
    ...
    @PutMapping("/web-api/v1/system/batch/manual/settle")
    public Integer settleBatchManual(@RequestBody SystemBatchRequest systemRequest) {
        LocalDateTime batchDate = DateTimeUtils.stringToLocalDateTime(systemRequest.getAggregatedAt());
